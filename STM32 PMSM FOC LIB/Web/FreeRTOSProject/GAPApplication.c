...
//#define TEST_PATTERN3


// Parameters
#if defined(TEST_PATTERN1)
...
#if defined(TEST_PATTERN2)
// Test pattern
#define GAP_CFG1 0x7B
#define GAP_CFG2 0xAA
#define GAP_CFG3 0xBB
#define GAP_CFG4 0xAA
#define GAP_CFG5 0xAA
#define GAP_DIAG1 0xAA
#define GAP_DIAG2 0xAA
#endif

#if defined(TEST_PATTERN3)
#define GAP_CFG1  GAP_CFG1_CRC_SPI | GAP_CFG1_DT_DISABLE | GAP_CFG1_INFILTER_DISABLE//| GAP_CFG1_UVLOD 
#define GAP_CFG2  GAP_CFG2_SENSETH_100MV | GAP_CFG2_DESATCURR_250UA | GAP_CFG2_DESATTH_3V
#define GAP_CFG3  GAP_CFG3_2LTOTH_7_0V | GAP_CFG3_2LTOTIME_DISABLE
#define GAP_CFG4  GAP_CFG4_UVLOTH_VH_DISABLE | GAP_CFG4_UVLOTH_VL_DISABLE
#define GAP_CFG5  GAP_CFG5_2LTO_ON_FAULT
#define GAP_DIAG1 GAP_DIAG_SPI_REGERR | GAP_DIAG_UVLOD_OVLOD | GAP_DIAG_UVLOH_UVLOL | GAP_DIAG_OVLOH_OVLOL | GAP_DIAG_DESAT_SENSE | GAP_DIAG_ASC_DT_ERR | GAP_DIAG_TSD | GAP_DIAG_TWN
#define GAP_DIAG2 GAP_DIAG_SPI_REGERR | GAP_DIAG_UVLOD_OVLOD | GAP_DIAG_UVLOH_UVLOL | GAP_DIAG_OVLOH_OVLOL | GAP_DIAG_DESAT_SENSE | GAP_DIAG_ASC_DT_ERR | GAP_DIAG_TSD | GAP_DIAG_TWN
#endif

    
#if defined(TEST_MARIO)
#define SPI                    SPI1
...
#define SPI_NSD_PORT           GPIOB
#define SPI_NSD_PIN            GPIO_Pin_0
#endif 

#if defined(TEST_CLAUDIO)
#define SPI                    SPI2
#define SPI_REMAP              GPIO_NoRemap_SPI
...
#define SPI_NCS_PORT           GPIOE
#define SPI_NCS_PIN            GPIO_Pin_14
#define SPI_NSD_PORT           GPIOB
#define SPI_NSD_PIN            GPIO_Pin_15
#endif

#if defined(TEST_GENNARO)
#define SPI                    SPI2
#define SPI_REMAP              GPIO_NoRemap_SPI
#define SPI_SCK_PORT           GPIOB  
