/**
  ******************************************************************************
  * @file    STM32F4xx_dual_lcd.h
  * @author  MCD Application Team
  * @version V4.2.0
  * @date    04/16/2010
  * @brief   This file contains all the functions prototypes for the STM32F4xx_dual_lcd
  *          firmware driver.
  ******************************************************************************
  * @copy
  *
...
#ifndef __STM32F4XX_DUAL_LCD_H
#define __STM32F4XX_DUAL_LCD_H
...
/** @addtogroup STM32F4XX_DUAL_LCD
  * @{
  */ 


/** @defgroup STM32F4XX_DUAL_LCD_Exported_Types
  * @{
  */
typedef struct 
{
...
/** @defgroup STM32F4XX_DUAL_LCD_Exported_Constants
  * @{
  */ 
...
#define LCD_NWR_PIN             GPIO_Pin_11
#define LCD_NWR_GPIO_PORT       GPIOD
#define LCD_NWR_GPIO_CLK        RCC_AHB1Periph_GPIOD
...
#define LCD_SPI_SCK_GPIO_CLK    RCC_AHB1Periph_GPIOC
#define LCD_SPI_SCK_SOURCE      GPIO_PinSource10
#define LCD_SPI_SCK_AF          GPIO_AF_SPI3
#define LCD_SPI_MISO_PIN        GPIO_Pin_12                 
#define LCD_SPI_MISO_GPIO_PORT  GPIOC                       
#define LCD_SPI_MISO_GPIO_CLK   RCC_AHB1Periph_GPIOC
#define LCD_SPI_MISO_SOURCE     GPIO_PinSource12
#define LCD_SPI_MISO_AF         GPIO_AF_SPI3
#define LCD_SPI_MOSI_PIN        GPIO_Pin_11                 
#define LCD_SPI_MOSI_GPIO_PORT  GPIOC                       
#define LCD_SPI_MOSI_GPIO_CLK   RCC_AHB1Periph_GPIOC
#define LCD_SPI_MOSI_SOURCE     GPIO_PinSource11
#define LCD_SPI_MOSI_AF         GPIO_AF_SPI3
...
/** @defgroup STM32F4XX_DUAL_LCD_Exported_Macros
  * @{
  */
#define ASSEMBLE_RGB(R, G, B)    ((((R)& 0xF8) << 8) | (((G) & 0xFC) << 3) | (((B) & 0xF8) >> 3))   

#define LCD_HW_Init STEVAL_IHM039V1_LCD_Init
...
/** @defgroup STM32F4XX_DUAL_LCD_Exported_Functions
  * @{
  */ 
void LCD_DeInit(void);
void LCD_Setup(void);
void STEVAL_IHM039V1_LCD_Init(void);
