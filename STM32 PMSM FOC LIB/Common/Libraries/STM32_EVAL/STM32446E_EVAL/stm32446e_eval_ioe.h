...
/** 
  ...
  */ 
#if (!defined(__STM324xG_EVAL_H) && !defined(__STM32446E_EVAL_H))
typedef enum 
{ 
  JOY_NONE = 0,
  JOY_SEL = 1,
...
/** 
  ...
  */ 
#define IOE_I2C                          FMPI2C1
#define IOE_I2C_CLK                      RCC_APB1Periph_FMPI2C1
#define IOE_I2C_SCL_PIN                  GPIO_Pin_12
#define IOE_I2C_SCL_GPIO_PORT            GPIOD
#define IOE_I2C_SCL_GPIO_CLK             RCC_AHB1Periph_GPIOD
#define IOE_I2C_SCL_SOURCE               GPIO_PinSource12
#define IOE_I2C_SCL_AF                   GPIO_AF_FMPI2C
#define IOE_I2C_SDA_PIN                  GPIO_Pin_13
#define IOE_I2C_SDA_GPIO_PORT            GPIOD
#define IOE_I2C_SDA_GPIO_CLK             RCC_AHB1Periph_GPIOD
#define IOE_I2C_SDA_SOURCE               GPIO_PinSource13
#define IOE_I2C_SDA_AF                   GPIO_AF_FMPI2C
#define IOE_I2C_DR                       ((uint32_t)0x40006010) ??
...
#define IOE_DMA_CHANNEL                  DMA_Channel_2
#define IOE_DMA_TX_STREAM                DMA1_Stream5   
#define IOE_DMA_RX_STREAM                DMA1_Stream2
#define IOE_DMA_TX_TCFLAG                DMA_FLAG_TCIF5
#define IOE_DMA_RX_TCFLAG                DMA_FLAG_TCIF2

/** 
  * @brief  IO Expander Interrupt line on EXTI  
  */ 
#define IOE_IT_PIN                       GPIO_Pin_0
...
#define IOE_IT_EXTI_PIN_SOURCE           EXTI_PinSource0
#define IOE_IT_EXTI_LINE                 EXTI_Line0
#define IOE_IT_EXTI_IRQn                 EXTI0_IRQn   
...
/**
  ...
  */ 
#define JOY_IO_SEL                   IO_Pin_5
#define JOY_IO_DOWN                  IO_Pin_3
#define JOY_IO_LEFT                  IO_Pin_2
#define JOY_IO_RIGHT                 IO_Pin_1
#define JOY_IO_UP                    IO_Pin_4
#define JOY_IO_NONE                  JOY_IO_PINS
#define JOY_IO_PINS                  (uint32_t)(IO_Pin_1 | IO_Pin_2 | IO_Pin_3 | IO_Pin_4 | IO_Pin_5)
