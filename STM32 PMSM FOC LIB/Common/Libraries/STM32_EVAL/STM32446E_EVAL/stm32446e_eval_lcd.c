/**
  ...
  *          of STM32446E-EVAL evaluation board(MB786) RevB.
  ******************************************************************************
  * @attention
  *
...
/** @defgroup STM32446E_EVAL_LCD 
  * @brief This file includes the LCD driver for AM-240320L8TNQW00H (LCD_ILI9320)
  *        and AM240320D5TOQW01H (LCD_ILI9325) Liquid Crystal Display Modules
  *        of STM32446E_EVAL board.
  * @{
  */ 

/** @defgroup STM32446E_EVAL_LCD_Private_TypesDefinitions
  * @{
  */ 
typedef struct
{
...
/** @defgroup STM32446E_EVAL_LCD_Private_Defines
  * @{
  */
...
/** @defgroup STM32446E_EVAL_LCD_Private_Macros
  * @{
  */
...
/** @defgroup STM32446E_EVAL_LCD_Private_Variables
  * @{
  */ 
...
/** @defgroup STM32446E_EVAL_LCD_Private_FunctionPrototypes
  * @{
  */ 
#ifndef USE_Delay
...
/** @defgroup STM32446E_EVAL_LCD_Private_Functions
  * @{
  */ 
...
/* FMC Configuration ---------------------------------------------------------*/
  ...
  FMC_NORSRAMInitStructure.FMC_BurstAccessMode = FMC_BurstAccessMode_Disable;  /* NOR burst access */
  ...
  FMC_NORSRAMInitStructure.FMC_WriteBurst = FMC_WriteBurst_Disable; /* NOR write burst */
  FMC_NORSRAMInitStructure.FMC_ContinousClock = FMC_CClock_SyncOnly; /* NOR Continous Clock feature */
