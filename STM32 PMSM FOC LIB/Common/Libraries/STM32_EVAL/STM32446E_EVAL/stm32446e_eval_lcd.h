/**
  ...
  * @brief   This file contains all the functions prototypes for the STM32446E_eval_lcd.c
  *          driver.
  ******************************************************************************
  * @attention
  *
...
/** @defgroup STM32446E_EVAL_LCD_Exported_Types
  * @{
  */
typedef struct 
{
...
/** @defgroup STM32446E_EVAL_LCD_Exported_Constants
  * @{
  */ 
...
/** @defgroup STM32446E_EVAL_LCD_Exported_Macros
  * @{
  */
#define ASSEMBLE_RGB(R ,G, B)    ((((R)& 0xF8) << 8) | (((G) & 0xFC) << 3) | (((B) & 0xF8) >> 3)) 

#define LCD_HW_Init STM32446E_LCD_Init

/**
  * @}
  */ 

/** @defgroup STM32446E_EVAL_LCD_Exported_Functions
  * @{
  */ 
/** @defgroup  
  * @{
