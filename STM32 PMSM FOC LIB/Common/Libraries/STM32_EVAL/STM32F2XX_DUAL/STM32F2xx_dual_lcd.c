...
/**
  ...
  * @retval None
  */
void STEVAL_IHM022v2_LCD_Init(void)
{  
  /* Setups the LCD */
  LCD_Setup();
...
void LCD_CtrlLinesConfig(void)
{
  ...
  /* Enable GPIO clock */
  RCC_AHB1PeriphClockCmd(LCD_NCS_GPIO_CLK | LCD_NWR_GPIO_CLK | LCD_RS_GPIO_CLK, ENABLE);
